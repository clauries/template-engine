function mainHTML(manager) {
    console.log("Template-main: " + manager.name);
    return `
    <!DOCTYPE html>
<html lang="en">
    ...
    <div class="container">
        <div class="jumbotron jumbotron-fluid text-white bg-info">
            <div class="container justify-content-center">
                ...
                <p class="lead text-center">Team size: fill in here members</p>
            </div>
        </div>
...
<!--Append Engineer cards here-->
            <div class="engineer row justify-content-center">

            </div>
<!--Append Intern cards here-->
